...
func (s *SourceState) ApplyAll(system System, targetDir string, include *IncludeSet) error {
...
func (s *SourceState) ApplyOne(system System, targetDir, targetName string, include *IncludeSet) error {
